...
public partial class PortScannerViewModel : ObservableObject
{
    ...
    public IReadOnlyList<PortPreset> PortPresets { get; } = new PortPreset[]
    {
        ...
        new("Web extended", "80,81,88,443,591,2082,2083,2086,2087,2095,2096,3000,5000,7001,8000,8008,8080,8081,8088,8443,8834,8888,9000,9090,9443"),
        new("Databases",    "1433,1521,3306,5432,5984,6379,7000,7199,8086,9042,9200,9300,11211,27017,27018,27019,50000"),
        new("Remote access","22,23,3389,5900,5901,5902,5800,4899,5938,6568"),
        new("Mail",         "25,110,143,465,587,993,995,2525"),
        new("File sharing", "20,21,69,115,139,445,548,873,2049,989,990"),
        new("Windows / AD", "53,88,135,137,138,139,389,445,464,636,3268,3269,3389,5985,5986,9389"),
        new("VPN / proxy",  "500,1080,1194,1701,1723,3128,4500,8080,8118,8388,9050,51820"),
        new("IoT / camera", "554,1883,2323,5683,8554,8000,8081,9000,37777,49152"),
        new("Containers",   "2375,2376,2377,4243,5000,6443,8001,8080,9099,10250,10255"),
